...
export default function AdminCredentialPage(){
  ...
  try {
    ...
    const res = await fetch("https://pgthikana.in/api/admin/block", {
      method: "POST",
      headers: {
...
const unblockAdmin = async (adminId: number) => {
  try {
    ...
    const res = await fetch("https://pgthikana.in/api/admin/unblock", {
      method: "POST",
      headers: {
        "Authorization": `Bearer ${token}`,
        "Content-Type": "application/json",
...
useEffect(() =>{
  fetchAdmins();
    ...
    return (
        ...
        <div className="flex flex-col items-center w-full min-h-screen bg-white gap-5 pt-8 pb-10">
